...
public class CuraTestsMakeAppointmentFail {	
	...
	String EXPECTED_URI_VALUE_AFTER_MAKING_APPOINTMENT="https://katalon-demo-cura.herokuapp.com/appointment.php#summary";
	...
	@Test
	@Order(5)
	public void MakeAppointmentFail() throws InterruptedException {
		...
		String expectedURIAfterMakingAppointment=EXPECTED_URI_VALUE_AFTER_MAKING_APPOINTMENT;
		String actualURIMakingAppointmentFail=driver.getCurrentUrl();
		assertNotEquals(expectedURIAfterMakingAppointment, actualURIMakingAppointmentFail);
