...
public class CuraTestLoginFail {	
	...
	public void LoginFail() throws InterruptedException {
		...
		driver.findElement(By.id(INPUT_PASSWORD_LOGIN_ID)).sendKeys("test");
		Thread.sleep(500);
		
		driver.findElement(By.id(LOGIN_BUTTON_ID)).click();
		Thread.sleep(1000);
		
		assertTrue(driver.findElement(By.className("text-danger")).getText().contains("Login failed!"));
		...
		assertNotEquals(ExpectedPageTitle,ActualPageTitle);
		Thread.sleep(1000);
	}
	...
	public static void main(String[] args) throws InterruptedException {
		...
		CuraTestLoginFail object = new CuraTestLoginFail();
